;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="f6f6e09530c30fd230b33013eb2da70a";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["MjpR1Rr0ugWU"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["MjpR1Rr0ugWU"].options={"account":{"accountId":"AHxOz1mFaiMq","service":"googleanalytics","userId":"105388135548650731397"},"anonymizeIp":false,"id":"","organization":"120895803","social":false,"web-properties-for-120895803":"UA-120895803-1","webPropertySchemaNames":["web-properties-for-120895803"]};;CloudflareApps.installs["MjpR1Rr0ugWU"].URLPatterns=["^wearedevs.net/?.*$"];;if(CloudflareApps.matchPage(CloudflareApps.installs['MjpR1Rr0ugWU'].URLPatterns)){(function(){var options=CloudflareApps.installs['MjpR1Rr0ugWU'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("MjpR1Rr0ugWU"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
